package com.springapi.stereotypes;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.springapi.stereotypes.controller.ContactController;
import com.springapi.stereotypes.model.Person;
import com.springapi.stereotypes.repository.ContactRepository;
import com.springapi.stereotypes.service.ContactService;
...
class ApplicationTests {
    ...
    public void testRetrievePerson() throws Exception {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        // "java.lang.NullPointerException" being thrown during tests
        // inspecting why the tests are failing
        MockHttpServletResponse response = mockMvc.perform(post("/contact/save")
                .contentType("application/json")
